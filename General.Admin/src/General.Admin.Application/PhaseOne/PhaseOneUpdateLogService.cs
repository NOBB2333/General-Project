...
public class PhaseOneUpdateLogService : ITransientDependency
{
    private readonly ICurrentUser _currentUser;
    private readonly IRepository<AppUpdateLog, Guid> _updateLogRepository;
    private readonly IRepository<IdentityUser, Guid> _userRepository;

    public PhaseOneUpdateLogService(
    ...
    public async Task<List<PhaseOneUpdateLogDto>> GetListAsync()
    {
        ...
        return logs
            .Select(item => new PhaseOneUpdateLogDto
            {
    ...
    public async Task CreateAsync(PhaseOneUpdateLogSaveInput input)
    {
    ...
    public async Task UpdateAsync(Guid id, PhaseOneUpdateLogSaveInput input)
    {
